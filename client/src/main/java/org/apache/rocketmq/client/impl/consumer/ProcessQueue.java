 ...
 * processQueue是MessageQueue在消费端的重现、快照。pullMessageService从消息服务器默认每次拉取32条消息，按消息的队列偏移量顺序放在processQueue中，
...
public class ProcessQueue {
     ...
     * 消息消费线程从processQueue中的msgTreeMap中取出消息前先将消息临时存储在consumingMsgOrderlyTreeMap中
     */
    ...
    /**
     * 添加消息，pullMessageService拉取消息后，先调用该方法将消息添加到processQueue中
     * @param msgs
     * @return
     */
    ...
    /**
     * 将consumingMsgOrderlyTreeMap中所有消息重新放入到msgTreeMap中并清除consumingMsgOrderlyTreeMap
     */
